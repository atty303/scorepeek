...
pub(crate) struct AcquiredTachi {
...
#[derive(Clone, Debug)]
pub(crate) struct TachiHttpResponse {
    pub status: u16,
    pub content_length: Option<u64>,
    pub body: Vec<u8>,
}

pub(crate) trait TachiTransport {
...
pub(crate) struct UreqTachiTransport {
    agent: ureq::Agent,
}
