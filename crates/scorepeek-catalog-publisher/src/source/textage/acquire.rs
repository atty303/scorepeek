...
#[derive(Clone, Debug)]
pub(crate) struct AcquiredTextage {
...
#[derive(Clone, Debug)]
pub(crate) struct TextageHttpResponse {
    pub status: u16,
    pub content_length: Option<u64>,
    pub body: Vec<u8>,
}

pub(crate) trait TextageTransport {
    fn get(
        &self,
        resource: TextageResource,
...
pub(crate) struct UreqTextageTransport {
    agent: ureq::Agent,
}
