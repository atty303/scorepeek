...
use crate::source::common::{
    Fixture, FixtureChart, parse_fixture, snapshot, validate_charts, validate_record_count,
};
...
pub(crate) struct TextageLiveAdapter;
...
pub(crate) fn textage_bundle_digest<'a>(
