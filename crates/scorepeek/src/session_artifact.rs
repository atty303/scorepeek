...
pub fn publish(request: &PublishRequest<'_>) -> Result<PathBuf, String> {
    ...
    let manifest = SessionManifest {
        ...
        field_observation_busy_skips: request.field_observation_busy_skips,
        maximum_consecutive_field_observation_busy_skips: request
...
mod tests {
    ...
    fn publication_expands_predicates_and_overlays_retained_recognition() {
        ...
        let published = publish(&PublishRequest {
            ...
            field_observation_busy_skips: 3,
            maximum_consecutive_field_observation_busy_skips: 2,
