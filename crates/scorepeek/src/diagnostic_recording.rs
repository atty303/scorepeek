...
pub enum DiagnosticDetail {
    ...
    ScreenPredicateObservation {
        ...
        play_bpm_outline_cyan_component_pixels: u32,
        play_bpm_outline_cyan_component_pixels_min: u32,
        play_bpm_outline_cyan_component_pixels_max: u32,
        play_bpm_outline_width: u32,
        play_bpm_outline_width_min: u32,
        play_bpm_outline_width_max: u32,
        play_bpm_outline_height: u32,
        play_bpm_outline_height_min: u32,
        play_bpm_outline_height_max: u32,
        play_bpm_outline_top_edge_pixels: u32,
        play_bpm_outline_top_edge_pixels_min: u32,
        play_bpm_outline_middle_row_pixels: u32,
        play_bpm_outline_middle_row_pixels_max: u32,
        play_bpm_outline_bottom_edge_pixels: u32,
        play_bpm_outline_bottom_edge_pixels_min: u32,
    },
    FieldObservation {
        screen: DiagnosticScreen,
        observed_fields: u8,
