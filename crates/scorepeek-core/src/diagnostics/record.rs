...
pub enum DiagnosticDetail {
    ...
    ScreenPredicateObservation {
        ...
        title_bright_bbox: Option<crate::recognition::Roi>,
        title_bright_channel_min: u8,
        title_qualifies: bool,
        result_warm_pixels: u32,
        result_warm_pixels_min: u32,
        result_panel_side: crate::recognition::ResultPanelSideState,
        result_panels: [crate::recognition::ResultPanelPresenceEvidence; 2],
        ...
        play_presence: crate::recognition::PlayPresenceEvidence,
    },
    FieldObservation {
        screen: DiagnosticScreen,
        observed_fields: u8,
