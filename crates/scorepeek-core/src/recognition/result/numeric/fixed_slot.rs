...
/// Extracts registered fixed-slot numeric cells from result-screen crops.
///
/// # Errors
/// Returns an error when a registered layout is invalid or a crop cannot be normalized.
...
/// Produces the registered fixed-slot feature vector for one numeric cell.
///
/// # Errors
/// Returns an error when the RGB input shape is invalid or feature extraction fails.
