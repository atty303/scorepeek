...
mod tests {
    ...
    use crate::diagnostics::writer::DiagnosticRunStatus;
    use crate::recognition_live::RecognitionSession;
    use scorepeek_core::diagnostics::{DiagnosticPolicy, DiagnosticResource};
    ...
    fn solid_frame(color: [u8; 3], generation: u64, sequence: u64) -> BoundCanonicalFrame {
        let mut pixels = Vec::with_capacity(crate::diagnostics::writer::CANONICAL_BYTES);
        for _ in 0..crate::diagnostics::writer::CANONICAL_BYTES / 3 {
    ...
    fn complete_screen_output_stays_bound_and_diagnostics_do_not_change_it() {
        ...
        assert_eq!(
            ...
            crate::diagnostics::ring::DiagnosticEnqueueOutcome::Disabled
        );
        assert_eq!(
            observation.output().as_ref().unwrap().screen(),
            ScreenClass::Result
