...
pub enum DiagnosticDetail {
    ...
    ScreenPredicateObservation {
        ...
        title_bright_bbox: Option<scorepeek_core::recognition::Roi>,
        title_bright_channel_min: u8,
        title_qualifies: bool,
        result_warm_pixels: u32,
        result_warm_pixels_min: u32,
        result_panel_side: scorepeek_core::recognition::ResultPanelSideState,
        result_panels: [scorepeek_core::recognition::ResultPanelPresenceEvidence; 2],
