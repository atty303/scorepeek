#![allow(
    ...
    reason = "internal offline simulation reports contextual string errors to its task wrapper"
)]
...
use crate::diagnostics::writer::{DiagnosticCompleteness, DiagnosticPolicy, DiagnosticRunStatus};
