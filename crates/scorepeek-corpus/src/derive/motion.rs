...
use scorepeek_core::replay::{CatalogStore, ScorepeekSongId};
use scorepeek_core::replay::{
...
fn record_temporal_update(
    update: Option<scorepeek_core::replay::MusicSelectTemporalUpdate<ScorepeekSongId>>,
...
fn resolve_stored_music_select(
    ...
    let observations = ScreenFieldObservations::MusicSelect(MusicSelectScreenFieldObservations {
        best: scorepeek_core::replay::MusicSelectBestObservation::default(),
        play_type: scorepeek_core::replay::MusicSelectPlayTypeObservation::default(),
        play_side: scorepeek_core::replay::MusicSelectPlaySideObservation::default(),
        ...
        selected_difficulty: MusicSelectDifficultyObservation {
            ...
            margin_ppm: 0,
            slots: [
                scorepeek_core::replay::Difficulty::Beginner,
                scorepeek_core::replay::Difficulty::Normal,
                scorepeek_core::replay::Difficulty::Hyper,
                scorepeek_core::replay::Difficulty::Another,
                scorepeek_core::replay::Difficulty::Leggendaria,
            ]
...
fn decode_motion_samples(
    video: &File,
    profile: &scorepeek_runtime::capture::GamescopeProfileBinding,
...
fn decode_motion_segment(
    ...
    let expected_pts = segment
        ...
        .collect::<Vec<_>>();
    let ffmpeg = crate::ingest::recording::find_executable("ffmpeg")?;
...
fn normalize_region(
    ...
    profile
        ...
        .normalize_bgrx_region(
            ...
            profile.observed_height(),
            stride,
            scorepeek_runtime::capture::CanonicalRegion {
                left: roi.x,
                top: roi.y,
                width: roi.width,
                height: roi.height,
...
fn probe_video(
    ...
    let ffprobe = crate::ingest::recording::find_executable("ffprobe")?;
