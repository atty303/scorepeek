        ...
        let setup = fs::create_dir(&root)
            ...
            .and_then(|()| {
                ...
                executable.and_then(|path| {
                    crate::replay::oracle::digest_file(&path).map_err(|error| error.to_string())
                })
            });
    ...
    if let Some(opened) = file.as_mut() {
        let metadata = serde_json::json!({
            ...
            "selected_sources_sha256": crate::replay::oracle::digest(concat!(
                ...
                include_str!("../../../scorepeek-core/src/recognition/title/decode.rs"),
                include_str!("../../../scorepeek-core/src/recognition/title/resolve.rs"),
                include_str!("../../../scorepeek-core/src/recognition/music_select/play_type.rs"),
                include_str!("../../../scorepeek-core/src/recognition/music_select/best.rs"),
                include_str!("../../../scorepeek-core/src/recognition/music_select/observe.rs"),
                include_str!("../../../scorepeek-core/src/recognition/music_select/resolve.rs"),
                include_str!("../../../scorepeek-core/src/recognition/result/observe.rs"),
                include_str!("../../../scorepeek-core/src/recognition/result/panel.rs"),
                include_str!("../../../scorepeek-core/src/recognition/result/play_options.rs"),
                include_str!("../../../scorepeek-core/src/recognition/result/resolve.rs"),
                include_str!("../../../scorepeek-core/src/recognition/result/numeric/fixed_slot.rs"),
                include_str!("../../../scorepeek-core/src/recognition/result/numeric/onnx.rs"),
                include_str!("../../../scorepeek-core/src/recognition/shared/ctc.rs"),
                include_str!("../../../scorepeek-core/src/recognition/shared/candidates.rs"),
                include_str!("../../../scorepeek-core/src/recognition/shared/confidence.rs")
            ).as_bytes()),
            "integrated_layout_sha256": crate::replay::oracle::digest(include_bytes!("../../../scorepeek-core/src/integrated-context-layout-v8.json")),
...
mod tests {
    ...
    fn play_presence() -> scorepeek_core::replay::PlayPresenceEvidence {
        scorepeek_core::replay::PlayPresenceEvidence {
    ...
    fn raw_result_candidate() -> RunEvent {
        RunEvent {
            ...
            kind: RunEventKind::RawScreenObserved {
                ...
                result_presence: scorepeek_core::replay::ResultPresenceEvidence {
                    warm_pixels: 3_200,
                    warm_pixels_min: 3_000,
                    panel_side: scorepeek_core::replay::ResultPanelSideState::Unknown(
                        scorepeek_core::replay::ResultPanelSideUnknownReason::NoCandidate,
                    ),
                    panels: [
                        scorepeek_core::replay::ResultPanelPresenceEvidence {
                            panel_side: scorepeek_core::replay::ResultPanelSide::Left,
                            upper_panel_edge_pixels: 540,
                            lower_panel_edge_pixels: 500,
                            qualifies: false,
                        },
                        scorepeek_core::replay::ResultPanelPresenceEvidence {
                            panel_side: scorepeek_core::replay::ResultPanelSide::Right,
