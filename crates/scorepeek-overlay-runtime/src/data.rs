...
pub type Diagnostic = std::sync::Arc<dyn Fn(&str, &serde_json::Value) + Send + Sync>;
    ...
    pub fn start(
        ...
        let worker = thread::Builder::new()
            ...
            .spawn(move || {
                ...
                while !stopping.load(Ordering::Acquire) {
                    ...
                    }
                    {
                        ...
                        if *current != consumer.view {
                            ...
                            emit("state_applied", &serde_json::json!({
                ...
                emit("feed_summary", &serde_json::json!({"received_records": received, "state_updates": updates, "history_checks": history_checks}));
            })?;
        Ok(Self {
            state,
            stop,
            ...
            view.history = History {
                ...
                graph_ticks: (0..=12)
                    ...
                    .filter_map(|months| {
                        ...
                        Some(scorepeek_overlay::GraphTick {
