...
- selection song contextとlive replay telemetry storage: 着手（最小context reducer、operator確認済み
  ...
  status/list control、cross-process active ownership、crash-safe aggregate retentionまで。freeze/delete/export、
  live capture、accepted field認識、event daemonは未着手）
