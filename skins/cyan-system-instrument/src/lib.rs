//! Cyan System Instrument: a new, self-contained skin tree for ABI v2.
...
fn panel(key: &str, kind: &str, widget: &Widget, content: Vec<Node>) -> Node {
    ...
    element(
        ...
        "section",
        &[
            ("class", format!("instrument-panel {kind}")),
