            ...
            element(
                ...
                vec![
                    ...
                    element(
                        ...
                        "div",
                        &[
                            ("class", "rank-block".into()),
                            ("data-rank", rank.to_owned()),
                        ],
                        vec![
                            text_element(
                            ...
                            text_element(&format!("{key}:rank:value"), "b", "rank-value", rank),
                ...
                vec![
                    ...
                    element(
                        ...
                        vec![
                            ...
                            text_element(&format!("{key}:clear:value"), "b", "clear-value", clear),
                        ],
                    ),
                ],
            ),
...
fn score(key: &str, widget: &Widget, state: &Value) -> Node {
    ...
    panel(
        ...
        widget,
        vec![
            score_best(key, state, &rank, &clear, delta, &fill_width),
            element(
                &format!("{key}:detail"),
                "div",
